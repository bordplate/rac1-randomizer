...
items = {
    ...
    {id=0x04,	location="Edwina's Shop",		host_item="Hydro-pack",			req_items={{keyid.hydrodisplacer}, {keyid.heli_pack}, {keyid.thruster_pack}} },					--Hoven
    ...
    {id=0x1A,	location="Construction Zone",	host_item="Trespasser",			req_items={{keyid.swingshot}, {keyid.heli_pack}, {keyid.thruster_pack}} },															--Aridia
    {id=0x1B,	location="Turret Fight", 		host_item="MetalDetector",		req_items={{keyid.magneboots}, {keyid.heli_pack}, {keyid.thruster_pack}} },															--Batalia
    ...
    {id=0x1F,	location="Hoverboard Race",		host_item="Hologuise",			req_items={{keyid.hoverboard, keyid.heli_pack}, {keyid.hoverboard, keyid.visibomb}, {keyid.thruster_pack}, {keyid.pda}} },										--KaleboIII
    {id=0x20,	location="Steve",				host_item="PDA",				req_items={{keyid.magneboots}} },																			--Oltanis
    {id=0x21,	location="Grind Rail",			host_item="Map-O-Matic",		req_items={{keyid.grindboots}, {keyid.pda, keyid.thruster_pack}} },																--KaleboIII
    {id=0x22,	location="Water path",			host_item="Bolt Grabber",		req_items={{keyid.hydro_pack, keyid.o2_mask}, {keyid.pda}} },																--Quartu
    {id=0x23,	location="Water Lab",			host_item="Persuader",			req_items={{keyid.raritanium, keyid.trespasser, keyid.hydrodisplacer}, {keyid.raritanium,keyid.o2_mask}} },													--Poki
    {id=0x30,	location="Hoverboard Race",		host_item="Zoomerator",			req_items={{keyid.heli_pack}, {keyid.thruster_pack}, {keyid.pda}} },															--Rilgar
    {id=0x31,	location="Drill Guy",			host_item="Raritanium",			req_items={{keyid.swingshot}, {keyid.heli_pack}, {keyid.thruster_pack}} },															--Hoven
    ...
    {id=0x35,	location="Nanotech Vendor 2",	host_item="Ultra Nanotech",		req_items={{keyid.premium_nanotech, keyid.o2_mask, keyid.heli_pack}, {keyid.premium_nanotech, keyid.o2_mask, keyid.thruster_pack}} },											--Orxon
}
...
infobots = {
    ...
    {id=0x06, req_items={{keyid.heli_pack}, {keyid.thruster_pack}, {keyid.decoy_glove}} },								-- Blarg infobot on Eudora, Robot Lieutenant
    {id=0x07, req_items={{keyid.heli_pack}, {keyid.thruster_pack}} },			-- Umbris infobot on Rilgar, Qwark's Trailer
    {id=0x08, req_items={{keyid.swingshot, keyid.heli_pack}, {keyid.swingshot, keyid.thruster_pack}} },							-- Batalia infobot on Umbris, Snagglebeast
    {id=0x09, req_items={{keyid.grindboots}, {keyid.heli_pack, keyid.pda}, {keyid.thruster_pack, keyid.pda}} },					-- Gaspar infobot on Batalia, Grind Rail
    {id=0x0A, req_items={} },													-- Orxon infobot on Batalia, Commando
    {id=0x0B, req_items={} },													-- Pokitaru infobot on Orxon, Clank 2
    {id=0x0C, req_items={{keyid.o2_mask,keyid.heli_pack}, {keyid.o2_mask,keyid.thruster_pack}} },							-- Hoven infobot on Orxon, Chase the infobot
    {id=0x0D, req_items={} },													-- Gemlik infobot on Hoven, Turret Fight
    {id=0x0E, req_items={{keyid.swingshot, keyid.magneboots,keyid.trespasser,keyid.devastator}, {keyid.heli_pack}, {keyid.thruster_pack}, {keyid.pda}} },	-- Oltanis infobot on Gemlik, Defeat Qwark
    {id=0x0F, req_items={{keyid.grindboots}, {keyid.pda}} },										-- Quartu infobot on Oltanis, Deaf guy
    ...
    {id=0x12, req_items={{keyid.thruster_pack}, {keyid.magneboots}, {keyid.decoy_glove}} }								-- Veldin2 infobot on Drek's Fleet, Battle through the ships
}
